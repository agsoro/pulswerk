...
declare function renderTimeseries(w: IWidget, body: HTMLElement | null, cfg: IWidgetConfig): Promise<void>;
declare function renderLatestValues(w: IWidget, body: HTMLElement | null, cfg: IWidgetConfig): Promise<void>;
declare function updateLatestValues(w: IWidget, cfg: IWidgetConfig): Promise<void>;
declare function renderSingleValue(w: IWidget, body: HTMLElement | null, cfg: IWidgetConfig): Promise<void>;
