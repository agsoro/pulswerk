...
const PulswerkValue = (() => {
     ...
     * @param {string} type     - BACnet object type string (e.g. "OBJECT_BINARY_VALUE")
     * @param {number} decimals - Decimal places for analog values (default 2)
     ...
     *
     * @param {string} displayVal - The display string from the UI
     * @param {string} type       - BACnet object type string
