...
export function AlarmsPage() {
    ...
    return (_jsxs("div", { class: "flex flex-col gap-6 w-full page-enter", children: [_jsxs("div", { class: "flex gap-2 overflow-x-auto no-scrollbar pb-1 mb-2 sm:flex-wrap", "data-testid": "alarm-filters", children: [_jsxs("button", { class: `filter-chip shrink-0 ${filter === '' ? 'active' : ''}`, onClick: () => setFilter(''), children: ["All ", _jsx("span", { class: "opacity-65 ml-1", children: totalCount })] }), _jsxs("button", { class: `filter-chip chip-critical shrink-0 ${filter === 'CRITICAL' ? 'active' : ''}`, onClick: () => setFilter('CRITICAL'), children: [_jsx("i", { class: "fas fa-skull-crossbones mr-1.5" }), " Critical ", _jsx("span", { class: "opacity-65 ml-1", children: countCritical })] }), _jsxs("button", { class: `filter-chip chip-major shrink-0 ${filter === 'MAJOR' ? 'active' : ''}`, onClick: () => setFilter('MAJOR'), children: [_jsx("i", { class: "fas fa-exclamation-triangle mr-1.5" }), " Major ", _jsx("span", { class: "opacity-65 ml-1", children: countMajor })] }), _jsxs("button", { class: `filter-chip chip-minor shrink-0 ${filter === 'MINOR' ? 'active' : ''}`, onClick: () => setFilter('MINOR'), children: [_jsx("i", { class: "fas fa-exclamation-circle mr-1.5" }), " Minor ", _jsx("span", { class: "opacity-65 ml-1", children: countMinor })] }), _jsxs("button", { class: `filter-chip chip-warning shrink-0 ${filter === 'WARNING' ? 'active' : ''}`, onClick: () => setFilter('WARNING'), children: [_jsx("i", { class: "fas fa-bell mr-1.5" }), " Warning ", _jsx("span", { class: "opacity-65 ml-1", children: countWarning })] }), countAcked > 0 && (_jsxs("button", { class: `filter-chip chip-acked shrink-0 ${filter === 'ACKED' ? 'active' : ''}`, onClick: () => setFilter('ACKED'), children: [_jsx("i", { class: "fas fa-check-circle mr-1.5" }), " Acknowledged ", _jsx("span", { class: "opacity-65 ml-1", children: countAcked })] }))] }), _jsx("div", { class: "flex flex-col gap-4", "data-testid": "alarm-list", children: alarms.length === 0 ? (_jsxs("div", { class: "glass text-center py-16 text-slate-400 rounded-2xl", children: [_jsx("i", { class: "fas fa-bell-slash text-5xl opacity-20 mb-4 block" }), _jsx("p", { children: "No active alarms detected." })] })) : (alarms.map((alarm) => {
                    const isAcked = alarm.status.startsWith('ACTIVE_ACK') || alarm.status.startsWith('ACK');
                    const isWriteAllowed = window.pwCanWriteValue;
                    return (_jsxs("div", { class: `glass p-4 sm:p-5 rounded-2xl border border-slate-700 flex flex-col md:grid md:grid-cols-[auto_1fr_auto] items-start md:items-center gap-4 md:gap-6 transition-all duration-200 hover:bg-white/[0.02] ${isAcked ? 'opacity-70' : ''}`, children: [_jsx("div", { class: `hidden md:block w-1.5 h-10 rounded ${alarm.severity === 'CRITICAL' ? 'bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]' :
                                    alarm.severity === 'MAJOR' ? 'bg-amber-500' :
                                        alarm.severity === 'MINOR' ? 'bg-sky-400' : 'bg-slate-400'}` }), _jsxs("div", { class: "flex flex-col gap-1 min-w-0 w-full", children: [_jsxs("div", { class: "font-bold text-base text-slate-50 flex items-center gap-2 flex-wrap", children: [_jsx("div", { class: `md:hidden w-2 h-2 rounded-full ${alarm.severity === 'CRITICAL' ? 'bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.7)]' :
                                                    alarm.severity === 'MAJOR' ? 'bg-amber-500' :
                                                        alarm.severity === 'MINOR' ? 'bg-sky-400' : 'bg-slate-400'}` }), _jsx("span", { children: alarm.type }), isAcked && (_jsxs("span", { class: "text-[0.7rem] text-emerald-400 font-semibold inline-flex items-center gap-1", children: [_jsx("i", { class: "fas fa-check-circle" }), " Acknowledged"] }))] }), _jsxs("div", { class: "text-xs text-slate-400 flex gap-x-4 gap-y-1 flex-wrap", children: [_jsxs("span", { children: [_jsx("i", { class: "fas fa-tag mr-1 text-slate-500" }), " ", alarm.severity] }), _jsxs("span", { children: [_jsx("i", { class: "fas fa-map-marker-alt mr-1 text-slate-500" }), " ", alarm.originator] }), _jsxs("span", { children: [_jsx("i", { class: "fas fa-info-circle mr-1 text-slate-500" }), " ", alarm.status] }), alarm.telemetryKey && (_jsxs("span", { children: [_jsx("i", { class: "fas fa-key mr-1 text-slate-500" }), " ", alarm.telemetryKey] }))] }), alarm.message && (_jsx("div", { class: "mt-2 text-sm text-slate-200 leading-relaxed max-w-4xl break-words", children: alarm.message })), alarm.ackComment && (_jsxs("div", { class: "mt-2 text-xs text-slate-400 italic flex items-start gap-1.5", children: [_jsx("i", { class: "fas fa-comment-alt mt-0.5 text-sky-400 shrink-0" }), _jsx("span", { children: alarm.ackComment })] }))] }), _jsxs("div", { class: "w-full md:w-auto text-sm text-slate-400 text-left md:text-right shrink-0 pt-2 md:pt-0 border-t border-white/5 md:border-t-0 flex flex-row md:flex-col justify-between md:justify-start items-center md:items-end gap-2", children: [_jsx("div", { class: "font-mono text-xs", children: new Date(alarm.time).toLocaleString() }), _jsxs("div", { class: "mt-0 md:mt-3 flex items-center justify-end gap-2", children: [!isAcked && alarm.alarmId && (_jsxs("button", { class: `min-h-[44px] md:min-h-0 btn-sm border border-emerald-500 hover:bg-emerald-500/10 text-emerald-500 rounded px-3 py-1.5 md:py-1 text-xs font-semibold inline-flex items-center gap-1.5 bg-transparent ${isWriteAllowed ? '' : 'hidden'}`, onClick: () => setAckAlarm(alarm), children: [_jsx("i", { class: "fas fa-check" }), " Acknowledge"] })), alarm.telemetryKey && (_jsxs("button", { class: "min-h-[44px] md:min-h-0 btn-sm border border-slate-600 text-slate-400 hover:text-slate-300 hover:bg-slate-700/50 rounded px-3 py-1.5 md:py-1 text-xs inline-flex items-center gap-1.5 bg-transparent", onClick: () => window.openProperties(alarm.telemetryKey), children: [_jsx("i", { class: "fas fa-list" }), " Properties"] })), alarm.alarmId && (_jsxs("button", { class: `min-h-[44px] md:min-h-0 btn-sm border border-slate-600 text-slate-400 hover:text-red-400 hover:border-red-400/30 hover:bg-red-500/5 rounded px-3 py-1.5 md:py-1 text-xs inline-flex items-center gap-1.5 bg-transparent ${isWriteAllowed ? '' : 'hidden'}`, onClick: () => handleReset(alarm), children: [_jsx("i", { class: "fas fa-redo" }), " Reset"] }))] })] })] }, alarm.alarmId));
                })) }), ackAlarm && (_jsx("div", { class: "fixed inset-0 z-[9000] flex items-end sm:items-center justify-center bg-black/70 backdrop-blur-sm p-0 sm:p-4", "data-testid": "ack-modal", onClick: () => !submittingAck && setAckAlarm(null), children: _jsxs("div", { class: "glass w-full sm:w-[min(480px,90vw)] rounded-t-3xl sm:rounded-xl p-6 sm:p-8 flex flex-col gap-5 relative border border-white/10 shadow-2xl animate-slide-up-mobile sm:animate-none", onClick: e => e.stopPropagation(), children: [_jsxs("div", { class: "flex justify-between items-center", children: [_jsxs("h3", { class: "text-lg font-bold", children: [_jsx("i", { class: "fas fa-check-circle text-emerald-500 mr-2" }), " Acknowledge Alarm"] }), _jsx("button", { onClick: () => !submittingAck && setAckAlarm(null), class: "bg-transparent border-0 text-slate-400 cursor-pointer text-xl hover:text-white p-2", disabled: submittingAck, children: _jsx("i", { class: "fas fa-times" }) })] }), _jsx("div", { class: "text-sm text-slate-400 font-semibold bg-white/5 px-3 py-2 rounded-lg border border-white/[0.03]", children: ackAlarm.type || ackAlarm.alarmId }), _jsxs("div", { children: [_jsxs("label", { class: "text-xs text-slate-400 block mb-1.5 font-bold uppercase tracking-wider", children: ["Comment ", _jsx("span", { class: "opacity-50", children: "(optional)" })] }), _jsx("textarea", { rows: 3, placeholder: "Describe what action was taken\\u2026", value: ackComment, onInput: e => setAckComment(e.currentTarget.value), disabled: submittingAck, class: "w-full bg-slate-900/60 border border-slate-700 rounded-lg text-slate-50 px-3 py-2.5 font-sans text-sm resize-y outline-none focus:border-sky-400 transition-colors" })] }), ackAlarm.bacnetAckKey ? (_jsxs("p", { class: "text-[0.72rem] text-emerald-400 leading-relaxed font-semibold bg-emerald-400/5 p-2.5 rounded-lg border border-emerald-500/10", children: [_jsx("i", { class: "fas fa-plug mr-1.5" }), " A BACnet ", _jsx("code", { class: "bg-emerald-400/15 px-1.5 py-0.5 rounded text-[0.68rem] font-bold", children: "AlarmAcknowledgement" }), " will be sent to the originating controller."] })) : (_jsxs("p", { class: "text-[0.72rem] text-slate-400 opacity-70 leading-relaxed bg-white/5 p-2.5 rounded-lg border border-white/5", children: [_jsx("i", { class: "fas fa-info-circle mr-1.5" }), " This alarm has no active BACnet context. The acknowledgment will be recorded locally only."] })), ackStatusMsg && (_jsxs("div", { class: `text-xs p-2.5 rounded-lg font-bold flex items-center gap-2 ${ackStatusMsg.type === 'sending' ? 'bg-sky-400/5 text-sky-400 border border-sky-400/10' :
