...
(window as any).DrawioCodec = DrawioCodec;
(window as any).ConditionEvaluator = ConditionEvaluator;
(window as any).ScadaPickerController = ScadaPickerController;
(window as any).ScadaAnimationController = ScadaAnimationController;
