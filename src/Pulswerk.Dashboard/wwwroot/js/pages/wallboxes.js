...
export function WallboxesPage() {
    ...
    return (_jsxs("div", { class: "flex flex-col gap-6 w-full page-enter", children: [_jsxs("div", { class: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [_jsxs("div", { class: "glass p-5 rounded-xl border border-slate-700/60 flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("div", { class: "text-2xl font-black text-slate-100", children: wallboxes.length }), _jsx("div", { class: "text-[0.7rem] uppercase tracking-wider text-slate-400 font-bold mt-1", children: t('wb_total_wb') })] }), _jsx("div", { class: "w-10 h-10 rounded-lg bg-sky-400/10 text-sky-400 flex items-center justify-center text-lg", children: _jsx("i", { class: "fas fa-charging-station" }) })] }), _jsxs("div", { class: "glass p-5 rounded-xl border border-slate-700/60 flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("div", { class: "text-2xl font-black text-emerald-400", children: wallboxes.filter(w => w.connected).length }), _jsx("div", { class: "text-[0.7rem] uppercase tracking-wider text-slate-400 font-bold mt-1", children: t('wb_online') })] }), _jsx("div", { class: "w-10 h-10 rounded-lg bg-emerald-400/10 text-emerald-400 flex items-center justify-center text-lg", children: _jsx("i", { class: "fas fa-link" }) })] }), _jsxs("div", { class: "glass p-5 rounded-xl border border-slate-700/60 flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("div", { class: "text-2xl font-black text-amber-400", children: wallboxes.filter(w => w.status === 'Charging').length }), _jsx("div", { class: "text-[0.7rem] uppercase tracking-wider text-slate-400 font-bold mt-1", children: t('wb_active_charging') })] }), _jsx("div", { class: "w-10 h-10 rounded-lg bg-amber-400/10 text-amber-400 flex items-center justify-center text-lg", children: _jsx("i", { class: "fas fa-bolt animate-pulse" }) })] }), _jsxs("div", { class: "glass p-5 rounded-xl border border-slate-700/60 flex items-center justify-between", children: [_jsxs("div", { children: [_jsxs("div", { class: "text-2xl font-black text-sky-400", children: [wallboxes.reduce((acc, curr) => acc + curr.power, 0).toFixed(1), " kW"] }), _jsx("div", { class: "text-[0.7rem] uppercase tracking-wider text-slate-400 font-bold mt-1", children: t('wb_total_power') })] }), _jsx("div", { class: "w-10 h-10 rounded-lg bg-sky-400/10 text-sky-400 flex items-center justify-center text-lg", children: _jsx("i", { class: "fas fa-plug" }) })] })] }), _jsx("div", { class: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: wallboxes.map(wb => {
                    const isBusy = submitting !== null;
                    return (_jsxs("div", { class: "bg-slate-800 border border-slate-700/70 rounded-xl overflow-hidden flex flex-col shadow-lg transition-transform duration-150 hover:scale-[1.01]", children: [_jsxs("div", { class: "px-6 py-4 border-b border-slate-700/70 flex justify-between items-center bg-black/10", children: [_jsxs("div", { children: [_jsx("h3", { class: "font-bold text-slate-100 text-base", children: wb.name }), _jsx("p", { class: "text-xs text-slate-400 font-mono mt-0.5", children: wb.id })] }), _jsx("div", { class: "flex items-center gap-2", children: _jsx("span", { class: `text-xs font-bold uppercase tracking-wider px-2 py-0.5 rounded ${wb.connected ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`, children: wb.connected ? t('wb_online') : t('status_offline').charAt(0).toUpperCase() + t('status_offline').slice(1) }) })] }), _jsxs("div", { class: "p-6 grid grid-cols-2 gap-4 flex-1", children: [_jsxs("div", { class: "flex flex-col gap-1", children: [_jsx("span", { class: "text-[0.68rem] font-bold text-slate-400 uppercase tracking-wider", children: t('wb_status') }), _jsxs("span", { class: `text-sm font-semibold flex items-center gap-1.5 ${wb.status === 'Charging' ? 'text-amber-400' :
                                                    wb.status === 'Available' ? 'text-emerald-400' :
                                                        wb.status === 'Preparing' ? 'text-sky-400' : 'text-slate-300'}`, children: [_jsx("span", { class: `w-2 h-2 rounded-full ${wb.status === 'Charging' ? 'bg-amber-400 animate-pulse' :
                                                            wb.status === 'Available' ? 'bg-emerald-400' :
                                                                wb.status === 'Preparing' ? 'bg-sky-400' : 'bg-slate-500'}` }), wb.status] })] }), _jsxs("div", { class: "flex flex-col gap-1", children: [_jsx("span", { class: "text-[0.68rem] font-bold text-slate-400 uppercase tracking-wider", children: t('wb_active_user') }), _jsx("span", { class: "text-sm font-semibold text-slate-100 font-mono truncate", children: wb.activeUser })] }), _jsxs("div", { class: "flex flex-col gap-1", children: [_jsx("span", { class: "text-[0.68rem] font-bold text-slate-400 uppercase tracking-wider", children: t('wb_power') }), _jsxs("span", { class: "text-lg font-black text-sky-400", children: [wb.power.toFixed(2), " kW"] })] }), _jsxs("div", { class: "flex flex-col gap-1", children: [_jsx("span", { class: "text-[0.68rem] font-bold text-slate-400 uppercase tracking-wider", children: t('wb_total_energy') }), _jsxs("span", { class: "text-sm font-semibold text-slate-100 font-mono", children: [wb.energyImport.toFixed(1), " kWh"] })] }), _jsxs("div", { class: "flex flex-col gap-1 col-span-2 border-t border-slate-700/40 pt-3 mt-1 grid grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("span", { class: "text-[0.65rem] font-bold text-slate-500 uppercase tracking-wider", children: t('wb_curr_volt') }), _jsxs("div", { class: "text-xs font-semibold text-slate-300 mt-0.5", children: [wb.current.toFixed(1), " A \u00A0\u00B7\u00A0 ", wb.voltage.toFixed(0), " V"] })] }), wb.status === 'Charging' && (_jsxs("div", { class: "flex flex-col gap-1", children: [_jsxs("div", { class: "flex justify-between items-center text-[0.65rem] font-bold text-slate-500 uppercase tracking-wider", children: [_jsx("span", { children: t('wb_charge_rate') }), _jsxs("span", { class: "text-amber-400", children: [((wb.power / 11) * 100).toFixed(0), "%"] })] }), _jsx("div", { class: "w-full bg-slate-900 rounded-full h-2 overflow-hidden border border-slate-700/50 mt-1", children: _jsx("div", { class: "bg-gradient-to-r from-amber-500 to-yellow-400 h-full rounded-full transition-all duration-500", style: { width: `${Math.min(100, (wb.power / 11) * 100)}%` } }) })] }))] })] }), _jsxs("div", { class: "px-6 py-4 border-t border-slate-700/60 bg-black/10 flex items-center justify-end gap-2", children: [_jsxs("button", { onClick: () => handleCommand(wb.id, 'unlock'), disabled: isBusy || !wb.connected, class: "py-1.5 px-3 rounded-lg border border-slate-600 bg-slate-700/40 text-slate-200 text-xs font-semibold hover:bg-slate-700 hover:border-slate-500 disabled:opacity-40 disabled:pointer-events-none transition-colors", children: [_jsx("i", { class: "fas fa-key mr-1.5" }), t('wb_unlock')] }), wb.status === 'Charging' ? (_jsxs("button", { onClick: () => handleCommand(wb.id, 'stop'), disabled: isBusy || !wb.connected, class: "py-1.5 px-3.5 rounded-lg border border-red-500/30 bg-red-500/10 text-red-400 text-xs font-semibold hover:bg-red-500/20 disabled:opacity-40 disabled:pointer-events-none transition-colors", children: [_jsx("i", { class: "fas fa-stop mr-1.5" }), t('wb_stop_charge')] })) : (_jsxs("button", { onClick: () => {
                                            setSelectedRfid(rfids.length > 0 ? rfids[0].idTag : '');
                                            setCustomRfid('');
                                            setShowStartModal(wb.id);
                                        }, disabled: isBusy || !wb.connected, class: "py-1.5 px-3.5 rounded-lg border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-xs font-semibold hover:bg-emerald-500/20 disabled:opacity-40 disabled:pointer-events-none transition-colors", children: [_jsx("i", { class: "fas fa-play mr-1.5" }), t('wb_start_charge')] }))] })] }, wb.id));
                }) }), showStartModal !== null && (_jsx("div", { class: "fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4", children: _jsxs("div", { class: "bg-slate-800 border border-slate-700 rounded-xl shadow-2xl max-w-md w-full p-6 text-slate-100 flex flex-col gap-4", children: [_jsxs("div", { class: "flex justify-between items-center border-b border-slate-700 pb-3", children: [_jsx("h3", { class: "font-bold text-lg text-slate-50", children: t('wb_auth_title') }), _jsx("button", { onClick: () => setShowStartModal(null), class: "text-slate-400 hover:text-slate-200", children: _jsx("i", { class: "fas fa-times text-lg" }) })] }), _jsxs("div", { class: "flex flex-col gap-3", children: [_jsxs("p", { class: "text-xs text-slate-400", children: [t('wb_auth_desc').split('{0}')[0], _jsx("strong", { children: showStartModal }), t('wb_auth_desc').split('{0}')[1] || ''] }), _jsxs("div", { class: "flex flex-col gap-1.5", children: [_jsx("label", { class: "text-[0.68rem] font-bold text-slate-400 uppercase tracking-wide", children: t('wb_known_users') }), _jsxs("select", { value: selectedRfid, onChange: (e) => setSelectedRfid(e.target.value), class: "bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-sky-400 font-mono", children: [_jsx("option", { value: "", children: t('wb_custom_card') }), rfids.map(r => (_jsxs("option", { value: r.idTag, children: [r.userName, " (", r.idTag, ")"] }, r.idTag)))] })] }), selectedRfid === '' && (_jsxs("div", { class: "flex flex-col gap-1.5", children: [_jsx("label", { class: "text-[0.68rem] font-bold text-slate-400 uppercase tracking-wide", children: t('wb_custom_rfid') }), _jsx("input", { type: "text", value: customRfid, onInput: (e) => setCustomRfid(e.target.value), placeholder: "e.g. A1B2C3D4", class: "bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-sky-400 font-mono" })] }))] }), _jsxs("div", { class: "flex items-center justify-end gap-2 border-t border-slate-700 pt-3 mt-2", children: [_jsx("button", { onClick: () => setShowStartModal(null), class: "py-2 px-4 rounded-lg bg-slate-700 text-slate-200 text-xs font-semibold hover:bg-slate-600 transition-colors", children: t('btn_cancel') }), _jsx("button", { onClick: () => handleCommand(showStartModal, 'start', { rfid: selectedRfid || customRfid }), disabled: selectedRfid === '' && !customRfid, class: "py-2 px-4 rounded-lg bg-sky-500 text-slate-950 text-xs font-bold hover:bg-sky-400 disabled:opacity-40 disabled:pointer-events-none transition-colors", children: t('wb_auth_start') })] })] }) }))] }));
}
